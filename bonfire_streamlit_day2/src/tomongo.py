...
#         self.df_final.columns = self.df.columns.str.replace(' ', '_').str.strip().str.lower()
...
#     c.create_df('/Users/investmentguy/Tableau_Bonfire_124/bonfire_124_streamlit_app/bonfire_124_streamlit_app/student-mat.csv',
#                 '/Users/investmentguy/Tableau_Bonfire_124/bonfire_124_streamlit_app/bonfire_124_streamlit_app/student-por.csv')
...
class ToMongo():
    ...
    def __init__(self, user=os.getenv('USERNAME'), password=os.getenv('PASSWORD')):
        ...
        self.user = user
        self.password = password
        self.mongo_url = os.getenv('mongodb+srv://addsev:Basic1234@cluster0.t1yof7a.mongodb.net/?retryWrites=true&w=majority')
        # Connecting to PyMongo
        self.client = pymongo.MongoClient(self.mongo_url)
        # Creating a database
        self.db = self.client.db
